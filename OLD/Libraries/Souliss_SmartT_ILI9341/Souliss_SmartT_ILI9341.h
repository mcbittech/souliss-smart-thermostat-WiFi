/***************************************************
  ...
  Modified Sep 2015 by mcbittech - rewrite font
 ****************************************************/

#ifndef _Souliss_SmartT_ILI9341H_
#define _Souliss_SmartT_ILI9341H_
...
class Souliss_SmartT_ILI9341 : public Souliss_SmartT_ILI9341_GFX_Library {

 public:
#ifndef ESP8266
  Souliss_SmartT_ILI9341(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK,
		   int8_t _RST, int8_t _MISO);
#endif
#if defined(USE_HW_CS) || defined(USE_NO_CS)
  Souliss_SmartT_ILI9341(int8_t _DC, int8_t _RST = -1);
#else
  Souliss_SmartT_ILI9341(int8_t _CS, int8_t _DC, int8_t _RST = -1);
#endif
  void     begin(void),
