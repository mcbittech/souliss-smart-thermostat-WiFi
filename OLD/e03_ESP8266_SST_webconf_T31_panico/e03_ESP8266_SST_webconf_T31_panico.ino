...
void loop()
{
  EXECUTEFAST() {
    ...
    FAST_10ms() {
     ...
     if (getEncoderValue() != setpoint) {
        display_print_setpoint(tft, getEncoderValue());
        setpoint = getEncoderValue();
        //memorizza il setpoint nel T31
        SERIAL_OUT.print("getEncoderValue arrotondato: "); SERIAL_OUT.println(getEncoderValue());
        SERIAL_OUT.print("setpoint Souliss arrotondato: "); SERIAL_OUT.println(setpoint);
        //Setto il setpoint su T31
...
{
  return round(int(v*100))/100; //100=10^2 per 2 cifre decimali 
}
*/
