...
void display_print_C4(Ucglib_ILI9341_18x240x320_HWSPI, float);
void display_print_C5(Ucglib_ILI9341_18x240x320_HWSPI, float);
void display_print_C6(Ucglib_ILI9341_18x240x320_HWSPI, float);
...
void alwaysdisplayTopicsHomePageLayout2 (Ucglib_ILI9341_18x240x320_HWSPI, float, float, float, float, float, float);
